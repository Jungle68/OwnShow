package com.jungle68.baseproject.dagger.module;

import android.app.Application;
import android.text.TextUtils;

import com.jungle68.baseproject.net.intercept.RequestIntercept;
...
//                .addConverterFactory(ScalarsConverterFactory.create())// 使用 Scalars
