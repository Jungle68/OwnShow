...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable throwable) {
        Observable.just(throwable)
                ...
                .subscribe(throwable1 -> MobclickAgent.reportError(BaseApplication.getContext(), throwable1), throwable12 -> {
                    throwable12.printStackTrace();
                    MobclickAgent.reportError(BaseApplication.getContext(), throwable12);
                });
