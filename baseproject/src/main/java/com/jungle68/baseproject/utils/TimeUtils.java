...
public class TimeUtils {
    ...
    public static final String HOUR_MINUITES = "HH:mm";
    public static final long DAY_LONG = 86400000;
    public static final long MINIUTES_LONG = 60000;
     ...
     * @return
     */
    public static String millis2String(String pattern,long millis){
