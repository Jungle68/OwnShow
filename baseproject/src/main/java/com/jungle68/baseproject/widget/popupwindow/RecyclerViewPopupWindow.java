package com.jungle68.baseproject.widget.popupwindow;
...
import com.jungle68.baseproject.utils.recycleviewdecoration.LinearDecoration;
import com.jungle68.baseproject.utils.recycleviewdecoration.ShareDecoration;
...
public class RecyclerViewPopupWindow extends PopupWindow{
    ...
    private RecyclerViewPopupWindow(RecyclerViewPopupWindow.Builder builder) {
        ...
        this.mIsWrap = builder.mIsWrap;
        this.mAnimation = builder.mAnimation;
        this.mBackground = builder.mBackground;
        this.mItemSpacingColor = builder.mItemSpacingColor;
    ...
    private void initView() {
        initLayout();
        setWidth(mIsWrap ? LinearLayout.LayoutParams.WRAP_CONTENT : LinearLayout.LayoutParams.MATCH_PARENT);
        setHeight(LinearLayout.LayoutParams.WRAP_CONTENT);
        setFocusable(mIsFocus);
        setOutsideTouchable(mIsOutsideTouch);
        setBackgroundDrawable(mBackgroundDrawable);
        setAnimationStyle(mAnimation);
    ...
    private void initLayout() {
        ...
        RecyclerView recyclerView = (RecyclerView) mContentView.findViewById(R.id
                .rv_popup_window);
        recyclerView.setBackgroundResource(mItemSpacingColor);
        // 设置布局管理器
        switch (mOritation) {
            case VERTICAL:
                ...
                LinearDecoration verticalLinearDecoration = new LinearDecoration(0, mItemSpacing, 0, 0);
                verticalLinearDecoration.setNeedLastDecoration(false);
                recyclerView.addItemDecoration(verticalLinearDecoration);
            ...
            case HORIZONTAL:
                ...
                LinearDecoration linearDecoration = new LinearDecoration(0, 0, 0, mItemSpacing);
    ...
    public void show() {
        ...
        if (mParentView != null) {
            ...
            showAtLocation(mContentView, gravity, 0, 0);
        }
    }
    ...
    public static final class Builder {
        ...
        private int mItemSpacingColor;
        private boolean mIsWrap;
        private int mAnimation = R.style.style_actionPopupAnimation;
        private int mBackground;
        ...
        public RecyclerViewPopupWindow.Builder onItemClick(MultiItemTypeAdapter.OnItemClickListener onItemClickListener){
            this.onItemClickListener = onItemClickListener;
            return this;
        }

        public RecyclerViewPopupWindow.Builder gravity(int gravity){
        ...
        public RecyclerViewPopupWindow.Builder isWrap(boolean isWrap) {
            this.mIsWrap = isWrap;
            return this;
        }

        public RecyclerViewPopupWindow.Builder animationStyle(int animation) {
            this.mAnimation = animation;
            return this;
        }

        public RecyclerViewPopupWindow.Builder background(int background) {
            this.mBackground = background;
            return this;
        }
        public RecyclerViewPopupWindow.Builder itemSpacingColor(@ColorRes int mItemSpacingColor) {
            this.mItemSpacingColor = mItemSpacingColor;
            return this;
        }
